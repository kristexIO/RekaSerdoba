...
systemd-analyze verify "$release_dir/systemd/rekaserdoba.service" "$release_dir/systemd/rekaserdoba-net-helper.service" "$release_dir/systemd/rekaserdoba-maintenance.service" "$release_dir/systemd/rekaserdoba-maintenance.timer"
...
test ! -f /etc/systemd/system/rekaserdoba-maintenance.service || install -m 0644 /etc/systemd/system/rekaserdoba-maintenance.service "$backup/systemd/rekaserdoba-maintenance.service"
test ! -f /etc/systemd/system/rekaserdoba-maintenance.timer || install -m 0644 /etc/systemd/system/rekaserdoba-maintenance.timer "$backup/systemd/rekaserdoba-maintenance.timer"
...
test ! -f /usr/local/libexec/rekaserdoba-maintenance || install -m 0755 /usr/local/libexec/rekaserdoba-maintenance "$backup/libexec/rekaserdoba-maintenance"
...
install -m 0644 "$release_dir/systemd/rekaserdoba-maintenance.service" /etc/systemd/system/rekaserdoba-maintenance.service
install -m 0644 "$release_dir/systemd/rekaserdoba-maintenance.timer" /etc/systemd/system/rekaserdoba-maintenance.timer
...
install -m 0755 "$release_dir/libexec/rekaserdoba-maintenance" /usr/local/libexec/rekaserdoba-maintenance
...
systemctl enable --now rekaserdoba-maintenance.timer
